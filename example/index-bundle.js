...
},{"./partial.hbs":6,"./template.hbs":7,"hbsfy/runtime":5}],2:[function(require,module,exports){
/*jshint eqnull: true */
...
},{"handlebars/lib/handlebars/base":2,"handlebars/lib/handlebars/runtime":3,"handlebars/lib/handlebars/utils":4}],6:[function(require,module,exports){
...
},{"hbsfy/runtime":5}],7:[function(require,module,exports){
// hbsfy compiled Handlebars template
var Handlebars = require('hbsfy/runtime');
module.exports = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
...
function program1(depth0,data) {
  ...
  buffer += escapeExpression(((stack1 = helpers.capitalize || depth0.capitalize),stack1 ? stack1.call(depth0, depth0.name, options) : helperMissing.call(depth0, "capitalize", depth0.name, options)))
    + "</h1>\n<p>My links are:</p>\n<ul>";
